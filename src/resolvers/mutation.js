...
module.exports = {
    newNote: async (parent, args, { models, user }) => {
        //if there is not user on the context, throw authentication error
        if(!user){
    ...
    signIn: async (parent, { username, email, password }, { models }) => {
        ...
        //if the passwords don't match, throw auth error
    ...
    toggleFavorite: async (parent, { id }, { models, user }) => {
        ...
        if (hasUser >= 0) {
            ...
            //add them to the list and incrememnt favoriteCount by 1
            return await models.Note.findByIdAndUpdate(
                id,
                {
                    $push: {
